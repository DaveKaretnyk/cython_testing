...
class TestCythonize(unittest.TestCase):
    ...
    def test_copy_tree(self):
        ...
        # change modification time of a file in test_source_dist, do the _copy_tree and check that
        # only that file as been updated in test_destination_dist)
    ...
    def test_create_pyx_packages_incremental(self):
        ...
        # validate that no included_py_module.pyx has not been created and that included
        # py_module.pyd has not been modified
        test_destination_dist_path = os.path.join(self.test_destination_dir, dist_name)
        included_packages = os.path.join(test_destination_dist_path, "included_packages")
    ...
    # TODO: Find out a way to unit test 'python setup.py cythonize' and
    #  'python setup.py cythonize_incremental'
